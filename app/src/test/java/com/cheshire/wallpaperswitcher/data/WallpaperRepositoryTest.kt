...
class WallpaperRepositoryTest {
    ...
    @Test
    fun `save and get seen images`() = runTest {
    ...
    @Test
    fun `save and get to remove images`() = runTest {
    ...
    @Test
    fun `loadCache returns empty data when file does not exist`() = runTest {
    ...
    @Test
    fun `loadCache returns data from file`() = runTest {
        val baseDir = repository.baseDir
    ...
    @Test
    fun `getSeenImages handles empty file`() = runTest {
        val baseDir = repository.baseDir
